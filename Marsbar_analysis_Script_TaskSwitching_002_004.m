...
%IMPORTANT: THIS SCRIPT WORKS ONLY ON SUB-002 AND 004 RUN THIS SCRIPT FIRST AND THEN RUN THE SCRIPT INCLUDING ALL THE PARTICIPANTS
%STEP 8 has been commented her. use the other Task switching script for copyng data on excel
...
for n=1:size(subjs,1)
    ...
    K= dir(fullfile(subjroot ,'con_0010.nii')); % %  contrast= 0 0 0 0 1 1 stay all trials(left and right) % get images from sttrast directory where they are stored
    J = spm_vol(K);
...
% 
% subjs={ '003';  '006';'007';'008';'011'; '013';'014'; '015'; '016'; '017'; '018';'021';'023';'028';'031';'032';'041'; '042'; '101';'104';'106'; '107';'108'; '110';'111'; '115'; '116'; '118';'119';'122'; '124';'127'; '129';'130';'131';'132';'133';'134';'136'}; 
%  
